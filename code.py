...
print("📈 Best Score (CV):", random_search_rf.best_score_)
...
random_search_lg.fit(X_train_resampled, y_train_resampled)

# Best model
best_lg = random_search_lg.best_estimator_

# Print best parameters
print("\n✅ Best Parameters:", random_search_lg.best_params_)
print("📈 Best Score (CV):", random_search_lg.best_score_)
...
print("📈 Best Score (CV):", random_search_knn.best_score_)
...
print("📈 Best Score (CV):", random_search_dt.best_score_)
...
# Print results
print("\n✅ Best Parameters:", random_search_ada.best_params_)
print("📈 Best Score (CV):", random_search_ada.best_score_)
...
print("📈 Best Score (CV):", random_search_gb.best_score_)
...
print_cross_validation_scores(rf, X, y, "Random Forest")
print_cross_validation_scores(lg, X, y, "Logistic Regression")
print_cross_validation_scores(svm, X, y, "SVM")
print_cross_validation_scores(xgb, X, y, "XGBoost")
print_cross_validation_scores(knn, X, y, "KNN")
print_cross_validation_scores(dt, X, y, "Decision Tree")
print_cross_validation_scores(ada, X, y, "AdaBoost")
print_cross_validation_scores(gb, X, y, "Gradient Boosting")
